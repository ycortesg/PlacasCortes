            ...
            <div>                
                <c:choose>
                    ...
                    <c:otherwise>
                        ...
                        <button id="inicioSesion" type="button" data-bs-toggle="modal" data-bs-target="#exampleModal" class="bg-light p-2 rounded-4 border-login px-3 shadow-sm">Iniciar Sesion</button>
