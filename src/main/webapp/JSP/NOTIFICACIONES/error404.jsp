...
<html lang="es">
    ...
    <body class="d-flex align-items-center justify-content-center bg-black bg-opacity-10 vh-100">
        <div class="w-50 h-50 d-flex align-items-center justify-content-between position-relative p-3 rounded-4 error " style="background-image: url('${applicationScope.imagenes}NOTIFICACIONES/404.jpg')">
            <c:choose>
                ...
                <c:otherwise>
                    <svg xmlns="http://www.w3.org/2000/svg" fill="orange" class="bi bi-person img-fluid d-block mx-auto h-75" viewBox="0 0 16 16">
